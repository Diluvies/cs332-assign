...
abstract class TweetSet {
   ...
   * and be implemented in the subclasses?
   */
   def union(that: TweetSet): TweetSet   // This should remain abstract, and implemented in the subclasses
...
class Empty extends TweetSet {
  ...
  def mostRetweeted: Tweet = throw new NoSuchElementException("Tweet Set is Empty")
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def mostRetweeted: Tweet = {
    ...
    List(leftMost, rightMost, elem).maxBy(_.retweets)
  }

  def descendingByRetweet: TweetList = {
    val mostRtTw = mostRetweeted
    new Cons(mostRtTw, remove(mostRtTw).descendingByRetweet)
  }
